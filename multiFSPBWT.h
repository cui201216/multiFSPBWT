...
template<class Syllable>
int multiFSPBWT<Syllable>::readMacsQuery(string query_file) {
    clock_t start, end;
    start = clock();
...
template<class Syllable>
int multiFSPBWT<Syllable>::makePanel() // fuzzy way :overall
{
    //get fuzzyX
    clock_t start, end;
    start = clock();
...
template<class Syllable>
bool multiFSPBWT<Syllable>::outPanelSyllableMultiEqual(int index_panel, int index_query, int k) {
...
template<class Syllable>
void multiFSPBWT<Syllable>::outPanelRefine(int L, int s_idx, int e_idx, int index_panel, int index_query,
                                          std::ofstream &out) {
    bool startDone=false;
    bool endDone=false;
    int start = 0, end = 0;
...
template<class Syllable>
void multiFSPBWT<Syllable>::outPanelIdentification(int L, int s_idx, int e_idx, int index_panel,
